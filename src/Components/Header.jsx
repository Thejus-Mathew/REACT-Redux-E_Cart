    ...
    <div>
        <Navbar collapseOnSelect expand="lg" className="bg-dark">
            <Container>
                ...
                <Nav>
                    <Link className='fs-3 mx-3 mt-4 me-5' style={{textDecoration:"none",color:"rgb(190,190,190)"}} to={'/wishlist'}><i className="fa-solid fa-heart"></i>WishList<Badge bg="danger rounded fs-6 position-absolute top-5 ms-1">9</Badge></Link>
